...
function MainSidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-foreground/70 ring-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
